...
[System.Xml.Serialization.XmlRootAttribute(Namespace="http://www.sat.gob.mx/cfd/3", IsNullable=false, ElementName = "Comprobante")]
public partial class Comprobante {
    ...
    [XmlIgnore]
    public decimal IepsExt { get; set; }

    [XmlIgnore]
    public decimal IvaExt { get; set; }

    [XmlIgnore]
    public string Qr { get; set; }

    [XmlIgnore]
    public Nomina12Cfdi.Nomina12 Nomina12 { get; set; }

    [XmlIgnore]
    public ValesDespensa1.ValesDeDespensa ValesDespensa { get; set; }
...
public partial class ComprobanteConceptoImpuestos {
    ...
    public List<ComprobanteConceptoImpuestosRetencion> Retenciones {
        ...
        set {
            this.retencionesField = value != null ? (value.Count == 0 ? null : value): value;
        }
    }
}
...
public partial class ComprobanteConceptoParte {
    ...
    private decimal claveProdServField;
...
public partial class ComprobanteComplemento {
    ...
    [XmlIgnore]
    public TimbreFiscalDigital TimbreFiscal { get; set; }

    private System.Xml.XmlElement[] anyField;
    //private List<XElement> anyField;
    /// <remarks/>
    [System.Xml.Serialization.XmlAnyElementAttribute()]
    public System.Xml.XmlElement[] Any {
    //public List<XElement> Any
    //{
        get {
            return this.anyField;
        }
